...
export default function FillInTheGapExercisesPage() {
  const {
    ...
    error,
    refetch,
  } = useQuery("/exercises/fillinthegap");
        ...
        {exercises.map((exercise) => (
          ...
          >
            <Column flex="1">
              ...
              >
                <Link
                  href={`/grammar/exercises/fillinthegap/${exercise.id}`}
            ...
            <Column gap="sm" align="flex-end">
              ...
              <Link
                href={`/admin/create-exercise/fillinthegap/${exercise.id}/edit`}
              >
